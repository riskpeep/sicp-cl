...
;  this procedure using Ben’s suggestion.  After debugging her program, 
;  Alyssa shows it to a potential user, who complains that her program solves 
;  the wrong problem. He wants a program that can deal with numbers 
;  represented as a center value and an additive tolerance; for example, he 
;  wants to work with intervals such as 3:5 ± 0:15 rather than [3.35, 3.65].
;  Alyssa returns to her desk and fixes this problem by supplying an 
